\begin{table*}[t]
\begin{tabular*}{\textwidth}{>{\bfseries}l >{\bfseries}l >{\bfseries}l @{\extracolsep{\fill}}>{\hspace{2em}}r r r r r r >{\hspace{2em}}r r}
\toprule
Dataset & Model & Level & Accuracy & Precision & Recall & AUC & F\textsubscript{1}-score & F\textsubscript{4}-score & t\textsubscript{fit} & t\textsubscript{pred} \\
\midrule
...
& 0.681 & 0.640 & \textbf{0.826} & 0.681 & 0.721 & 0.712 & \NA{} & \SI{0.059}{\second} \\
