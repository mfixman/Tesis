...
\footnotetext{And these features are informative and actually improve the prediction, as shown in the huge difference between predicting using each model and the one a level higher, particularly $\cat_1$ to $\cat_2$.}
