...
In case of a tie (which happens often when using the \emph{Outer Graph}), the category is chosen randomly. Theis approach can be formalized as in Equation~\ref{eq:majority_voting}.
