...
\toprule
\ct{Dataset} & \ct{Model} & \ct{Level} & \ct{Acc.} & \ct{Prec.} & \ct{Recall} & \ct{AUC} & \ct{F\textsubscript{1}} & \ct{F\textsubscript{4}} & \ct{t\textsubscript{fit}} & \ct{t\textsubscript{pred}} \\
\midrule
...
&       \num{0.681} & \num{0.640} & \num{0.826} & \num{0.681} & \num{0.721} & \num{0.812} & \SI{0.000}{\second} & \SI{0.059}{\second} \\

& \multicolumn{2}{>{\bfseries}l}{Bayesian\footnotemark{}}
&       \num{0.691} & \num{0.653} & \num{0.827} & \num{0.741} & \num{0.730} & \num{0.815} & \SI{0.000}{\second} & \SI{33.155}{\second} \\
\cmidrule{2-11}
...
&& 2  & \num{0.568} & \num{0.578} & \num{0.525} & \num{0.569} & \num{0.550} & \num{0.528} & \SI{0.119}{\second}   & \SI{0.003}{\second} \\
\cmidrule{2-11}
