...
To maximize accuracy, setting $\tau = 0.654$ results in a predictor where $\Accuracy = 0.687$ and $\FPR = 123$. Additionally, that value of $\tau$ results in $\Precision = 123$, $\Recall = 123$, $F_1 = 123$, and $F_4 = 123$. \todo{Fill these values.}
