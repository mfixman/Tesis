...
\item[\Cref{sec:comparison}] Presents other algorithms of differing complexity that work in the same dataset as the previous one, including ones based in common \emph{Machine Learning} with novel feature extraction methods. The final results are presented in \cref{tab:comparison}.
