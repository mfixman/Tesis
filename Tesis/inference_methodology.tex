...
\begin{equation}
\begin{aligned}
\contacts^{\low}_v &= \left| \left\{ e \in E \middle| \begin{aligned} e_o = v &\land e_d \in H_1 \\ &\lor \\ e_d = v &\land e_o \in H_1 \end{aligned} \right\} \right| \\
\contacts^{\high}_v &= \left| \left\{ e \in E \middle| \begin{aligned} e_o = v &\land e_d \in H_2 \\ &\lor \\ e_d = v &\land e_o \in H_2 \end{aligned} \right\} \right|
\end{aligned}
\end{equation}
