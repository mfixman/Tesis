...
Our data source requested the income data to be agnostic of currency. Since this study could apply to any country with a similar level of bancarization, the standard symbol ¤ will be used to refer to this generic currency~\cite{ISO8859}.
