...
\begin{itemize}
\item 5 persons, based in Vicente Lopez (Buenos Aires)... \\ and growing!
...
\item Conferences: NetMob, ASONAM, KDD, ...
\item Journals: AI Communications, Elsevier Computer Communications, ...
...
\item We construct an \textcolor{blue}{inferential algorithm} that allows us to predict the socioeconomic status of users.
...
\begin{figure}
\begin{center}
{\includegraphics[width=0.8\columnwidth] % ,trim={0.5cm 0.5cm 1.5cm 1cm},clip=true]
{figures/income_age_boxplot4/income_age_boxplot4.png}}
\label{income_age_boxplot}
\end{center}
\end{figure}
Distribution of income $b_s$ according to age $b_a$. 
...
{figures/cumulative_income.png}}
\label{fig:income_distribution}
\end{center}
\end{figure}
Lorenz curve representing the distribution of income of bank clients.
...
According to the World \cite{world_bank}, the Gini coefficient for whole Mexico was 0.481 in 2012. 
...
{Homophily_income_origin_target_low.png}}
...
\begin{itemize}
\item $R_1 = \left[1000, 6300\right)$ i.e. low income
\item $R_2 = \left[6300, \infty\right)$ i.e. high income
\end{itemize} 
...
\begin{figure}
\begin{center}
{\includegraphics[width=0.7\columnwidth] % ,trim={0.5cm 0.5cm 1cm 1cm},clip=true]
{figures/ROC_BETA/ROC_Beta_based_approach_201504.png}}
\label{ROC_multiclass}
\end{center}
\end{figure}

ROC curve for prediction procedure. We observed an $\AUC = 0.74$ indicating that our predictor is better than a random predictor ($\AUC \simeq 0.50$).
...
ROC curves for multiclass problem.
